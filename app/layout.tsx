...
import { LayoutDashboard, TrendingUp, UserCheck, HeadphonesIcon, CreditCard, Bell, Settings } from "lucide-react";
      ...
      <body className={inter.className}>
        <ThemeProvider attribute="class" defaultTheme="light" enableSystem>
          <div className="min-h-screen bg-background">
            ...
            <div className="flex">
              {/* Sidebar */}
              <aside className="w-[240px] border-r h-[calc(100vh-64px)] p-4 bg-background">
